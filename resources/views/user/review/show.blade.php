                        ...
                        <div class="preview">
                            @if ($review->status == ReviewStatusConsts::PASSED || $review->status == ReviewStatusConsts::REJECTED)
                                ...
                                <div class="overflow-y-auto mt-3 rounded-md">
                                    <p>ここに運営からのレビューコメントが入ります。ここに運営からのレビューコメントが入ります。ここに運営からのレビューコメントが入ります。</p>
                                    <p>ここに運営からのレビューコメントが入ります。ここに運営からのレビューコメントが入ります。</p>
                                    <p>ここに運営からのレビューコメントが入ります。ここに運営からのレビューコメントが入ります。ここに運営からのレビューコメントが入ります。</p>
                                    <p>ここに運営からのレビューコメントが入ります。ここに運営からのレビューコメントが入ります。</p>
                                </div>
                            @else
                                <div class="overflow-y-auto mt-3 rounded-md text-center">
